...
## Club Member Story :
  ...
  - As a games club member, I want the game to be interactive.
...
## Professor Story :
  ...
  - As a professor, I would like there to be an educational component to teach a students about the AI writing style in the system.

# 6. Acceptance Criteria
  - System initializes when the user starts the game
  - The system poses roles of the game to the user.
  ...
  - Player wins if the Ai is voted out, player loses if they are voted out
